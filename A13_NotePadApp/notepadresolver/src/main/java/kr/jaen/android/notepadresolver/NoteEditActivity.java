...
import kr.jaen.android.notepadresolver.databinding.ActivityNoteEditBinding;
...
public class NoteEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            Note temp = (Note) bundle.getSerializable(NoteConstant.DATABASE_TABLE);
        ...
        binding.confirm.setOnClickListener(view -> {
            ...
            reply.putSerializable(NoteConstant.DATABASE_TABLE, note);
